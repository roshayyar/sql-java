...
public class A02FrontEnd extends JFrame implements ItemListener, ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
		A02MiddleTier mid=new A02MiddleTier();
		queryOutput.setText(mid.statement(eventConference.isSelected(), eventJournal.isSelected(), eventBook.isSelected(), allDates.isSelected(), fromDate.getText(), toDate.getText()));
    }
